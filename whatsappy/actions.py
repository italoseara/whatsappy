...
def add_to_group(self, contact_name: str):
    ...
    try:
        ...
        self.driver.find_element_by_css_selector("div.TbtXF").click()
        ...
        try:
            ...
            self.driver.find_element_by_css_selector(
                "div.overlay._1814Z._3wXwX.copyable-area > div > div > div > div > div > div > span > div"
            ).click()
        except:
            pass
...
def remove_from_group(self, participant_name: str):
    ...
    try:
        ...
        self.driver.find_element_by_css_selector("div._3TVPy").click()
        ...
        self.driver.find_element_by_css_selector(
            "div._1C2Q3._36Jt6 > div:nth-child(1) > div > div > div > div > div"
        ).click()
...
def create_group(self, group_name: str, contacts: list):
    ...
    self.driver.execute_script(
        "document.querySelector('div._2n-zq._3zHcq > span > div > ul > li:nth-child(1)').click()"
    )

    for contact in contacts:
        box = self.driver.find_element_by_css_selector("div._3tEPr > div > div > input")
    ...
    self.driver.execute_script(
        "document.querySelector('div._1Flk2._2DPZK > span > div > span > div > div > span > div').click()"
    )
    ...
    self.driver.execute_script(
        "document.querySelector('div._1Flk2._2DPZK > span > div > span > div > div > span > div > div').click()"
    )
    sleep(2)
